...
#define MAX_SLEEP_SEC         86400 ///< Maximum `sleep` delay, in seconds.
#define MIN_SLEEP_SEC         0.001 ///< Minimum `sleep` delay, in seconds.
#define DEFAULT_SLEEP_SEC     0.050 ///< Default loop delay, in seconds.
...
#define MAX_EVAL_DEPTH           16 ///< Maximum expression evaluation stack depth.
